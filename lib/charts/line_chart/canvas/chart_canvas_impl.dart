...
class ChartCanvasImpl extends BaseChartCanvas {
  ...
  void drawRRect({
    ...
    final fillRectBounds = math.Rectangle<num>(
  ...
  void drawText({
    ...
    final txtDirection = textElement.txtDirection;
    ...
    if (rotation != 0) {
      if (txtDirection == TxtDirection.rtl) {
      ...
      // 居中显示
      if (txtDirection == TxtDirection.center) {
...
/// Convert dart:math [math.Rectangle] to Flutter [Rect].
Rect _getRect(math.Rectangle<num> rectangle) {
...
Shader _createShader(math.Rectangle<num> bounds, Color color) {
